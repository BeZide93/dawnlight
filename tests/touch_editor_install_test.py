...
struct EditorApi {void (*construct)(),(*push)(),(*top)(),(*uncover)(),(*hide)(),(*listenTouch)(),(*listenMouse)(),(*deleteListener)(),(*setClass)(),(*touchPosition)(),(*mousePosition)(),(*eventInt)(),(*dockAnchor)(),(*applyDock)(),(*applyTransform)();} s_editorApi;
bool resolveMethods=true;
template<class T> bool resolve_extra(const char*,T&){return resolveMethods;}
void layout_extra_editor(ModContext*,void*,void*,void*){}
void reset_extra_editor(ModContext*,void*,void*,void*){}
void after_save_extra_editor(ModContext*,void*,void*,void*){}
